  ...
  useEffect(() => {
    const fetchUpcomingCompletions = async () => {
      try {
        ...
        console.error(
          'Failed to fetch upcoming completions:',
          error
        );
      }
    };
    ...
    <div className="admin-dashboard-shell">
      ...
      <header className="admin-topbar">
        ...
        <div className="admin-topbar-user">
          ...
          <div>
            <strong>{user?.fullName || 'Team Leader'}</strong>
      ...
      >
        ...
        <nav className="admin-sidebar-nav">
          ...
          <button
            className={`admin-nav-item ${
              activeView === 'myInterns' ? 'active' : ''
            }`}
            onClick={() => setActiveView('myInterns')}
          >
            <span>♙</span>
            My Interns
          </button>
      ...
      <main className="admin-dashboard-main">
        <header className="admin-page-header">
          ...
          <p>
            {activeView === 'overview'
              ? 'Manage your team from one secure workspace.'
              : activeView === 'requests'
                ? 'Review intern requests waiting for your decision.'
                : activeView === 'myInterns'
                  ? 'View the interns assigned to your team.'
                  : 'Complete the details below to create an intern account.'}
          </p>
        </header>
        ...
        {activeView === 'overview' ? (
          <>
            ...
            <section
              ...
              aria-label="Team leader profile"
            >
              ...
              <div className="admin-quick-actions">
                ...
                >
                  ...
                  <small>
                    Register an intern for your team
                  </small>
                </button>
              </div>
            </section>

            {/* Upcoming Internship Completions */}
            <UpcomingCompletions
              interns={upcomingCompletions}
            />
          </>
        ) : activeView === 'requests' ? (
          <PendingReviewList />
          ...
          <div className="teamleader-form-grid">
            <CreateIntern />
          </div>
        )}
      </main>
